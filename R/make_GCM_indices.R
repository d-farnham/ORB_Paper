...
load('Processed_Data/SHUM_700_mod_field.RData')
load('Processed_Data/Z_700_mod_field.RData')
load('Processed_Data/OMG_700_mod_field.RData')
...
save(O_index_mod, file = 'Processed_Data/Shifted_reanalysis/O_index_mod.RData')
...
save(M_index_mod, file = 'Processed_Data/Shifted_reanalysis/M_index_mod.RData')
...
save(NPH_index_mod, file = 'Processed_Data/Shifted_reanalysis/NPH_index_mod.RData')
...
save(EWD_index_mod, file = 'Processed_Data/Shifted_reanalysis/EWD_index_mod.RData')
